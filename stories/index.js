...
storiesOf('InterviewerList', module)
  ...
  .add('Preselected', () => <InterviewerList interviewers={interviewers} value={3} onChange={action('setInterviewer')} />);
...
storiesOf('Appointment', module)
  ...
  .add('Edit', () => <Form name="Taejin Jung" interviewers={interviewers} interviewer={3} onSave={action('onSave')} onCancel={action('onCancel')} />);
