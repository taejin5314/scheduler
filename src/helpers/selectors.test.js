import { getAppointmentsForDay, getInterview, getInterviewersForDay, getDayOfAppointment } from 'helpers/selectors';
...
test('getDayOfAppointment returns the day of appointment', () => {
  const result = getDayOfAppointment(state, 3);
